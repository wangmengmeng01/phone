<template>
	<div class="productDetail" @click="$go('downLoad')">
		...
		<div class="productDetailCenter">
			<p class="productDetailCenterP boderB">出借协议<img src="../../assets/main/home/nextIcon.png" /></p>
			<p class="productDetailCenterP boderB">风险提示<img src="../../assets/main/home/nextIcon.png" /></p>
		</div>
