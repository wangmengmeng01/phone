<template>
  <div class="qrcode">
    <div class="head flex">
      ...
      <div class="msg">
        <h2 class="f36 flex"><span>{{item.userName}}</span><span v-if="!!item.position" class="status color_main"><img src="../../assets/main/mine/status_yellow.png" alt=""><i class="f12">{{['一般理财师','大区经理'][parseInt(item.position)-1]}}</i></span></h2>
